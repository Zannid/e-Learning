          ...
          <div class="row">
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-card mb-30">
                            ...
                            <div class="content">
                                <h6 class="mb-10">Materi</h6>
                                <h3 class="text-bold mb-10">{{ \App\Models\Materi::count() }}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-card mb-30">
                            ...
                            <div class="content">
                                <h6 class="mb-10">Quiz</h6>
                                <h3 class="text-bold mb-10">{{ \App\Models\Quiz::count() }}</h3>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-card mb-30">
                            ...
                            <div class="content">
                                <h6 class="mb-10">Tugas</h6>
                                <h3 class="text-bold mb-10">{{ \App\Models\Tugas::count() }}</h3>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-card mb-30">
                            ...
                            <div class="content">
                                <h6 class="mb-10">Siswa</h6>
                                <h3 class="text-bold mb-10">{{ \App\Models\User::where('role', 'siswa')->count() }}</h3>
            ...
            <div class="col-lg-7">
              <div class="card-style mb-30">
                <div class="title d-flex flex-wrap justify-content-between">
                  <div class="left">
                    <h6 class="text-medium mb-10">Diagram</h6>
